        ...
        <main className="ambient-grid pt-28">
          <PageContainer className="pb-16 sm:pb-20">
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1fr)_23rem]">
              <PurchasePanel products={products} paymentMethods={paymentMethods} user={user ? { id: user.id, name: user.name } : null} />
              <aside className="grid content-start gap-4">
                ...
                <PremiumPanel as="section">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-slate-400">Setelah order dibuat, halaman transaksi menampilkan status pembayaran, proses top up, total, dan riwayat update.</p>
                    </div>
                  </div>
                ...
                <PremiumPanel as="section">
                  ...
                  <div className="mt-4 grid gap-3 text-sm text-slate-400">
                    {["Pastikan User ID benar.", "Pilih server hanya jika game membutuhkannya.", "Jangan tutup halaman saat pembayaran diproses."].map((item) => (
